#time m++ main.cpp -D_WIN32_WINNT=0x0601 -o main.exe -I./include -lkernel32 -static-libgcc -static-libstdc++ -static -lws2_32 -g ; winedbg --gdb --port 12345 --no-start ./main.exe ; target extended-remote :12345
