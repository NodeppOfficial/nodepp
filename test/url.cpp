...
namespace TEST { namespace URL {
    ...
    void TEST_RUNNER(){
        ...
        TEST_ADD( test, "TEST 1 | url protocol", [](){
            try { string_t uri = "http://becerra:enmanuel@www.google.com/path/to/file#done?var1=10&var2=50&var3=100&var4=hello_world!";
        ...
        TEST_ADD( test, "TEST 1 | url pathname", [](){
            try { string_t uri = "http://becerra:enmanuel@www.google.com/path/to/file#done?var1=10&var2=50&var3=100&var4=hello_world!";
        ...
        TEST_ADD( test, "TEST 1 | url search", [](){
            try { string_t uri = "http://becerra:enmanuel@www.google.com/path/to/file#done?var1=10&var2=50&var3=100&var4=hello_world!";
        ...
        TEST_ADD( test, "TEST 1 | url origin", [](){
            try { string_t uri = "http://becerra:enmanuel@www.google.com/path/to/file#done?var1=10&var2=50&var3=100&var4=hello_world!";
