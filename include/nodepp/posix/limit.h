...
namespace nodepp { namespace limit {
    ...
    inline int set_process_priority( int priority ){ int n; switch( priority ) {
        case IDLE_PRIORITY:     n =  19; break;
        case LOW_PRIORITY:      n =  5 ; break;
        case NORMAL_PRIORITY:   n =  0 ; break;
        case HIGH_PRIORITY:     n = -5 ; break;
        case HIGHEST_PRIORITY:  n = -15; break;
        case REALTIME_PRIORITY: n = -20; break; default: return -1;
